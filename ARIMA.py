...
if __name__ == "__main__":
    ...
    # Plot the data
    data.plot()
    plt.ylabel('Monthly airline passengers (*1000)')
    plt.xlabel('Date')
    plt.show()

    # Define the d and q parameters to take any value between 0 and 2
    q = d = range(0, 2)
    ...
    # Let's fit the model with the parameters that gave the smallest AIC value
    mod = sm.tsa.statespace.SARIMAX(train_data,
